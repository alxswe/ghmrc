...
import { ClockIcon, DeviceDesktopIcon, RepoCloneIcon, RepoTemplateIcon, ServerIcon } from "@primer/octicons-react";

export const team = [
    {
        name: "Souheila Sidennas",
        role: "Graphic Designer",
        imageUrl:
            "https://media.licdn.com/dms/image/D4D03AQFuk3hiGdjXnw/profile-displayphoto-shrink_800_800/0/1694894744228?e=1706745600&v=beta&t=rECIsO56XYKhEHoDe2KXGPTo7_5VdsBVVmBmlB4gXvY",
        bio: "Passionate software engineering student with a diverse skill set. Experienced in graphic design, social media and marketing management, WordPress development, video editing. Eager to contribute to your team's success.",
        githubUrl: "https://github.com/Souheilaso",
        linkedinUrl: "https://www.linkedin.com/in/souheila-s/",
        twitterUrl: ""
    },
    {
        name: "Zakaria Khonchafi",
        role: "Full-Stack WD.",
        imageUrl:
            "https://media.licdn.com/dms/image/D4E03AQFDi7PHqKnD_Q/profile-displayphoto-shrink_800_800/0/1684417513925?e=1706745600&v=beta&t=6MyNlBMnv3zc2I-fJqI_wGJ6rPNLT-I2_SXOB2cB_o8",
        bio: "Passionate about merging strategic management with software engineering expertise. Leveraging my extensive knowledge in both fields, I can create innovative management systems that optimize performance and drive growth.",
        githubUrl: "https://github.com/zackkh",
        linkedinUrl: "https://www.linkedin.com/in/zakaria-khonchafi/",
        twitterUrl: ""
    },
];
...
export const features = [
    {
        icon: RepoCloneIcon,
        name: "Multi-Repository Cloning",
        description:
            "GHMRC enables users to effortlessly clone multiple GitHub repositories simultaneously, streamlining the process for developers and teams working on complex projects.",
    },
    {
        icon: ServerIcon,
        name: "Centralized Management",
        description:
            "The application provides a centralized platform for managing cloning tasks, allowing users to specify a list of GitHub repositories and automating the cloning process.",
    },
    {
        icon: ClockIcon,
        name: "Time Efficiency",
        description:
            "GHMRC is designed to save valuable time by automating the cloning process, reducing the manual effort required and enhancing overall project development efficiency.",
    },
    {
        icon: RepoTemplateIcon,
        name: "Error Reduction",
        description:
            "The tool minimizes the potential for errors in the cloning process, ensuring a smoother experience for developers and teams dealing with multiple repositories.",
    },
    // {
    //     icon: DeviceDesktopIcon,
    //     name: "User-Friendly Interface",
    //     description:
    //         "GHMRC features a user-friendly interface that facilitates easy navigation and configuration, making it accessible to developers of all skill levels.",
    // },
    // {
    //     icon: UserGroupIcon,
    //     name: "Collaboration Enhancement",
    //     description:
    //         "GHMRC enhances collaboration in software development projects by simplifying and automating the simultaneous cloning of multiple repositories.",
    // },
];
...
export const techStack: any[] = [
    {
        name: "Docker",
        imageUrl: "assets/logos/icons8-docker-144.png",
    },
    {
        name: "Postgres",
        imageUrl: "assets/logos/icons8-postgres-144.png",
    },
    {
        name: "Django",
        imageUrl: "assets/logos/icons8-django-144.png",
    },
    {
        name: "Django Rest Framework",
        imageUrl: "assets/logos/logo-918316357.png",
    },
    {
        name: "Next.js",
        imageUrl: "assets/logos/icons8-nextjs-144.png",
    },
    {
        name: "Celery",
        imageUrl: "assets/logos/celery_513.png",
    },
    {
        name: "Redis",
        imageUrl: "assets/logos/icons8-redis-an-in-memory-data-structure-project-implementing-a-distributed-96.png",
    },
    {
        name: "Memcached",
        imageUrl: "assets/logos/memcached.png",
    },
];

export const testRepos: IGithubRepository[] = [
    {
        id: 1,
...
export const testRateLimit = {
    resources: {
        core: { limit: 60, remaining: 56, reset: 1699981897, used: 4, resource: "core" },
        graphql: { limit: 0, remaining: 0, reset: 1699983633, used: 0, resource: "graphql" },
        ...
        search: { limit: 10, remaining: 10, reset: 1699980093, used: 0, resource: "search" },
    },
    rate: { limit: 60, remaining: 56, reset: 1699981897, used: 4, resource: "core" },
};
